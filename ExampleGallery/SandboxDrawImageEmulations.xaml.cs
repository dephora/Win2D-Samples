...
{
    public sealed partial class SandboxDrawImageEmulations : UserControl, INotifyPropertyChanged
    {
        public event PropertyChangedEventHandler PropertyChanged;

        public SandboxDrawImageEmulations()
        {
        ...
        public struct ModeDescription
        {
            ...
            public IDemo Create(SandboxDrawImageEmulations example, CanvasControl sender)
            {
        ...
        class OffsetDemo : IDemo
        {
            ...
            public OffsetDemo(SandboxDrawImageEmulations example, CanvasControl sender)
            {
        ...
        class DestRectDemo : IDemo
        {
            ...
            public DestRectDemo(SandboxDrawImageEmulations example, CanvasControl sender)
            {
                fillPattern = example.checkedFillPattern;
        ...
        class OpacityDemo : IDemo
        {
            ...
            public OpacityDemo(SandboxDrawImageEmulations example, CanvasControl sender)
            {
                fillPattern = example.checkedFillPattern;
