...
{
    public sealed partial class SandboxEffectsExample : UserControl
    {
        ...
        //CanvasBitmap bitmapBeardedSeal;
        ICanvasImage effect;
        ...
        {
            bitmapTiger = await CanvasBitmap.LoadAsync(sender, "imageBeardedSeal.png");
            //bitmapBeardedSeal = await CanvasBitmap.LoadAsync(sender, "imageBeardedSeal.png");
